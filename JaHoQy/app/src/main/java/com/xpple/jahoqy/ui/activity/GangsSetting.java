...
public class GangsSetting extends BaseActivity {
    ...
    private void intiData() {
        ...
        renMing.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void intiView() {
        renMing=$(R.id.GangAppointment);
        shenQing=$(R.id.EnterGangApply);
        gongGao=$(R.id.GangNotice);
