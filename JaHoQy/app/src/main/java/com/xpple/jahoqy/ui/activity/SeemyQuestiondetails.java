...
import com.xpple.jahoqy.adapter.myAnswerAdapter;
...
public class SeemyQuestiondetails extends BaseActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seemy_questiondetails);
        init();
    }
    ...
    private void init() {
        ...
        if(CurrentUser.getUserPhoto()!=null) {
            ...
            imageLoader.displayImage("http://file.bmob.cn/" + CurrentUser.getUserPhoto().getUrl(), ima, new ImageLoadingListener() {
                @Override
        ...
        uname= BmobUser.getCurrentUser(mContext).getUsername();
        una.setText(uname);


        BmobQuery<Question> query=new BmobQuery<>();
        query.addQueryKeys("title,picture1,picture2,picture3,state");
    ...
    private void initlist(){
        ...
        adapter = new myAnswerAdapter(this, items,state);
        ...
        listView.setOnItemClickListener(new ZrcListView.OnItemClickListener() {
            ...
            public void onItemClick(ZrcListView parent, View view, int position, long id) {
                ...
                if(!items.get(position).getUser().getObjectId().equals(BmobUser.getCurrentUser(mContext).getObjectId())) {
                    Intent item = new Intent(SeemyQuestiondetails.this, Shownearuser.class);
    ...
    private void querymoreAnswer(int page){
        ...
        query.findObjects(this, new FindListener<Answer>() {
            ...
            public void onError(int code, String msg) {
                Toast.makeText(SeemyQuestiondetails.this, msg, Toast.LENGTH_LONG).show();
                listView.stopLoadMore();
            }
        });
    }
