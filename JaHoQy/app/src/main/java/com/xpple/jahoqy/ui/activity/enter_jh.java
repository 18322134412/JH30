...
public class enter_jh extends BaseActivity {
    ...
    private void initView() {
        ...
        p.show();
        initTopBarForBoth("步入江湖", R.mipmap.ditu, R.mipmap.actionbar_brjh, R.color.default_title_indicator_text_color, new HeaderLayout.onRightImageButtonClickListener() {
            @Override
            public void onClick() {
