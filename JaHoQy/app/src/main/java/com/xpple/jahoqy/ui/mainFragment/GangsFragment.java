...
public class GangsFragment extends BaseFragment {
    ...
    private void initView(){
        ...
        iv_gangs_manage=(ImageView)getView().findViewById(R.id.iv_gangs_manage);
        iv_group_chat=(ImageView)getView().findViewById(R.id.iv_group_chat);
    ...
    private void initDate(){
        ...
        iv_gangs_manage.setOnClickListener(new View.OnClickListener() {
            @Override
